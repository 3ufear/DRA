...
public final class URI implements Comparable, Serializable {
   ...
   * @throws java.net.URISyntaxException which signals that URI has syntax error
   * @throws java.net.UnknownServiceException which signals that URI has incorrect scheme
   */
